...
//cookies
// Check if the user has a preference for a blue theme
if (isset($_COOKIE['blue_theme']) && $_COOKIE['blue_theme'] == 1) {
  // Include the styleBlue.css file
  echo "<link rel='stylesheet'  href='css/styleBlue.css'>";

}else {
  // Include the Default style file
            ...
            <div class="rd-navbar-main">
              ...
              <div class="rd-navbar-main-element">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <!-- RD Navbar User-->
                  <!-- si el usuario loguado muestra esta parte-->

                  <?php if (is_user_logged_in()) { ?>
                    <button class="fl-bigmug-line-user143 rd-navbar-user toggle-original active" data-rd-navbar-toggle=".cart-inline-2"></button>
                    <div class="cart-inline-2 toggle-original-elements active">
                      <div class="cart-inline-header">
                        <h5 class="cart-inline-title">Nombre:<span>
                            <?php
                            //si el usuario loguado muestra su nombre
                            echo getUserMarkup();

                            ?></span></h5>
                      </div>
                      <div class="cart-inline-body">
                        <!-- HTML form to submit the preference for a blue theme -->
                        <form action="setBlueTheme.php" method="post">
                          <div class="cart-inline-body">
                            <input type="checkbox" value="1" name="blue_theme" id="blue_theme_checkbox" onchange="submit()"> <label for="blue_theme_checkbox">Blue theme</label>
                          </div>
                        </form>
                      </div>
                      <div class="cart-inline-footer">
                        <div class="group-sm"><a class="button button-md button-default-outline-2 button-wapasha" href="logout.php">Log out</a><a class="button button-md button-primary button-pipaluk" href="#">UPDATE</a></div>
                      </div>
                    </div>
                  <?php } else { ?>
                    <button class="fl-bigmug-line-user143 rd-navbar-user toggle-original active" data-rd-navbar-toggle=".cart-inline-2"></button>
                    <div class="cart-inline-2 toggle-original-elements active">
                      ...
                      <div class="cart-inline-footer">
                        <div class="group-sm"><a class="button button-md button-default-outline-2 button-wapasha" href="login.php">Login</a><a class="button button-md button-default-outline-2 button-wapasha" href="register.php">register</a></div>
                      </div>
